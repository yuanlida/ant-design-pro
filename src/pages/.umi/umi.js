...
import findRoute, {
  getUrlQuery,
} from '/Users/lidayuan/Documents/edison/thunder/middle/ant-design-pro/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/lidayuan/Documents/edison/thunder/middle/ant-design-pro',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
